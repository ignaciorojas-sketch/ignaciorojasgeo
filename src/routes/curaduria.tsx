...
const CRONICA_CHOPOTECA = {
  ...
  textoCompleto: `Hay lugares que no se miden en metros cuadrados, sino en horas de aguja girando y en experiencias compartidas. Para mí, **La Chopoteca** es uno de esos territorios imposibles de cartografiar del todo. No es solo un recinto para la música; es la sala de estar de un grupo de amigos, la escuela de grandes y chicos, el taller donde se forjan conversaciones, proyectos musicales, risas y, a veces, lágrimas. Es donde el puerto deja de ser postal y se vuelve pulso.

Aún recuerdo la primera vez que llevé mis discos para participar en un Lunes de Selector@s en la chopoteca: pocos, misceláneos, sin saber si alcanzarían para sostener las seis horas que exige un Lunes de Selectores. Me enfrenté a un público que escucha con el cuerpo entero, que espera cada nuevo disparo desde los platos como quien aguarda una señal. Mientras pasaban las horas, la ansiedad se fue disolviendo. Dejé de estar frente a ellos para estar con ellos. Seis horas continuas en vinilo no se explican con palabras: se viven. Es ahí, en la resistencia del surco y en la paciencia de la aguja, donde uno se pule, donde conoce su propia selección y descubre que el vinilo no solo gira: te gira en su mismo eje. Es en ese momento donde comprendes donde estas y cual es su significado.

Con el tiempo, la Chopoteca dejó de ser solo un escenario para convertirse en taller, en espacio de educación, en archivo vivo, en segunda casa. He pasado de la mesa a la trastienda: reparando amplificadores, ajustando el **Doble Shot 69**, acompañando los *meet & greet* de **Quebrada Sound System**, tocando en la reinauguración, colaborando con un grano de arena en el trabajo que por años llevan sus fundadores. Pablo  —"el Chopo"- transformo este espacio en el punto donde la geografía y la música dejaron de ser disciplinas separadas. Fue **El Chopo** quien me abrió la mirada, quien me mostró que cuidar un sistema de sonido, intervenir en un cerro o armar una sesión son actos de la misma práctica: hacer lugar para que el sonido habite.

Si bien puede darse en cualquier rincon/espacio de este puerto olvidado, La Chopoteca se configura en lugares, pero nunca en jerarquías. El área del selector permite un contacto casi físico con la música, un puente entre quien elige y quien escucha. Pero lo que realmente la hace latir es la gente. Las charlas, los talleres, la venta de discos, la **Oficina Creativa Música y Trabajo**… todo converge en una misma filosofía: la música analógica no se consume, se habita.

La formula parece conocida y replicable en otros lugares. Pero La Chopoteca no es una fórmula exportable. Es hija del cerro, de la cultura porteña, de esa escena musical que se cuece a fuego lento y que ningún manual puede clonar. Su identidad no se diseña: se hereda del puerto.

Por todo eso, La Chopoteca tenía que ser la primera crónmica de este sitio. No por nostalgia, sino por necesidad: es el territorio donde se cruzan mi oficio, mi hobby, mi historia y la de tantos que han pasado por sus puertas. De seguro volveré a escribir sobre ella. Porque este lugar no solo guarda vinilos: guarda historias. Y mientras haya una aguja dispuesta a tocar, el puerto y La Chopoteca seguirá sonando.

Si aún no conoces La Chopoteca, no busques horarios, ni dirección en redes. Sube el cerro, sigue el grave, entra sin prisa. Pide un espacio, quédate hasta que la púa se detenga: escucha y contempla la selección de vinilos. Y cuando salgas, tal vez entiendas por qué Valparaíso no solo se recorre: se escucha..`
};
